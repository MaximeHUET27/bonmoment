...
export const metadata = {
  ...
  description: 'Mentions légales de bonmoment.app – Manon LISSE, micro-entrepreneur.',
}
...
<Tr label="Email de contact" value={<a href="mailto:bonmomentapp@gmail.com" className="text-[#FF6B00] hover:text-[#CC5500]">bonmomentapp@gmail.com</a>} />
              ...
              <Tr label="Directeur de la publication" value="Manon LISSE" last />
            </tbody>
          </table>
        </div>
        ...
        <div>
          ...
          <p className="mt-3">
            L&apos;ensemble du contenu du site bonmoment.app (textes, graphismes, logotypes, icônes, images, sons, vidéos, logiciels, bases de données) est la propriété exclusive de Manon LISSE ou de ses partenaires, et est protégé par les lois françaises et internationales relatives à la propriété intellectuelle.
          </p>
          <p className="mt-3">
            Toute reproduction, représentation, modification, publication, adaptation ou exploitation de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite sans l&apos;autorisation préalable écrite de Manon LISSE, sous peine de poursuites judiciaires.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-3">
            Manon LISSE s&apos;efforce d&apos;assurer l&apos;exactitude et la mise à jour des informations diffusées sur bonmoment.app. Toutefois, Manon LISSE ne peut garantir l&apos;exactitude, la complétude ou l&apos;actualité des informations diffusées sur ce site.
          </p>
          <p className="mt-3">
            Manon LISSE décline toute responsabilité pour tout dommage résultant de l&apos;utilisation du site ou de l&apos;impossibilité d&apos;y accéder, de même que pour tout dommage causé par des virus informatiques ou tout autre élément nuisible pouvant infecter l&apos;équipement informatique de l&apos;utilisateur.
          </p>
        </div>
