...
export async function GET() {
  ...
  const [
    ...
    admin.from('reservations').select('id, offre_id, statut, created_at, utilise_at').neq('statut', 'annulee').gte('created_at', debutMois),
    admin.from('reservations').select('id, statut').neq('statut', 'annulee').gte('created_at', debutMoisPre).lt('created_at', finMoisPre),
