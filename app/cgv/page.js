      ...
      <section className="flex-1 px-4 py-8 max-w-2xl mx-auto w-full flex flex-col gap-10 text-[#3D3D3D] text-sm leading-relaxed">
        ...
        <div>
          ...
          <table className="w-full text-sm border-collapse mt-3">
            <tbody>
              <Tr label="Vendeur" value="Maxime HUET — Auto-entrepreneur" />
              ...
              <Tr label="Numéro de TVA" value={<em className="text-[#3D3D3D]/60">En cours, à compléter dès réception</em>} last />
            </tbody>
          </table>
        </div>
        ...
        <div>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr className="border-b border-[#F5F5F5]">
                  ...
                  <td className="px-4 py-3">29,00 € HT / mois — soit <strong>34,80 € TTC</strong> (TVA 20 %) — 4 offres/mois — Bons illimités</td>
                </tr>
                <tr className="border-b border-[#F5F5F5] bg-[#FFF8F3]">
                  <td className="px-4 py-3 font-semibold text-[#FF6B00]">Essentiel</td>
                  <td className="px-4 py-3">49,00 € HT / mois — soit <strong>58,80 € TTC</strong> (TVA 20 %) — 8 offres/mois — Bons illimités</td>
                </tr>
                <tr>
                  <td className="px-4 py-3 font-semibold text-[#0A0A0A]">Pro</td>
                  <td className="px-4 py-3">79,00 € HT / mois — soit <strong>94,80 € TTC</strong> (TVA 20 %) — 16 offres/mois — Bons illimités</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="mt-4 bg-[#F5F5F5] rounded-2xl px-5 py-4">
            ...
            <ul className="list-disc pl-5 space-y-1 mb-3">
              <li>Palier Découverte (29 € HT/mois) : remise de <strong className="text-[#0A0A0A]">10 € HT</strong> pour le parrain et le filleul</li>
              <li>Palier Essentiel (49 € HT/mois) : remise de <strong className="text-[#0A0A0A]">15 € HT</strong> pour le parrain et le filleul</li>
              <li>Palier Pro (79 € HT/mois) : remise de <strong className="text-[#0A0A0A]">20 € HT</strong> pour le parrain et le filleul</li>
            </ul>
        ...
        <div>
          ...
          <p className="mt-2">
            La facturation est mensuelle, par prélèvement automatique via Stripe à la date anniversaire de souscription. Une facture conforme (numéro séquentiel, TVA détaillée) est automatiquement générée et envoyée par email après chaque prélèvement.
          </p>
          <SubTitle className="mt-4">4.2 Taxes</SubTitle>
          <p className="mt-2">
            Les prix affichés sont en euros hors taxes (HT). La TVA applicable est de 20 %. Le montant TTC est clairement indiqué lors de la souscription et sur chaque facture.
          </p>
        ...
        <p className="text-xs text-[#3D3D3D]/40 text-center pt-4 border-t border-[#F5F5F5]">
          Document établi le Mars 2026 — bonmoment.app — Maxime HUET — Conforme Code de la consommation et Code de commerce français
        </p>
